        ...
        <SafeAreaView style={styles.bgColor}>
            <View style={[styles.container, styles.bgColor]}>
                ...
                <View style={[styles.buttonContainer]}>
                    <TouchableOpacity style={styles.button1} onPress={handleSignup}><Text style={styles.buttonTitle1} >Sign up</Text></TouchableOpacity>
                    <TouchableOpacity style={styles.button2} onPress={handleLogin}><Text style={styles.buttonTitle2} >Log in</Text></TouchableOpacity>
                </View>
            </View>
        </SafeAreaView>
    );
