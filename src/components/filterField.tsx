...
function FilterField(props: any): JSX.Element {
    ...
    return (
        <TouchableOpacity style={isToggled?styles.buttonSelected:styles.button} onPress={handleToggle}>
                <Text style={isToggled?styles.buttonTitleSelected:styles.buttonTitle}>{props.fieldData}</Text>
        </TouchableOpacity>
    )
}
